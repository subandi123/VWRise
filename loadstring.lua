...
-- Add this function at the top of your script
    ...
    -- Then modify your hookfunction to include the print:
        ...
        if type(gc) == "function" then
            ...
            if info.name == "AskForChoice" and string.find(info.source:lower(), "tictactoe") then
                local OldFunc; OldFunc = hookfunction(gc, function(...)
                    ...
                    local board = {{0,0,0},{0,0,0},{0,0,0}} -- Initialize empty board
                    ...
                    if typeof(boardModel) == "Instance" then
                        ...
                        -- Print the board before making the move
                        printBoard(board)
                        
                        local move = ai:getBestMove(board)
                        print("\nAI choosing move:", move) 
                        return move
                    end
